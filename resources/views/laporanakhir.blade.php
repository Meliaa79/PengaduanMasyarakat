...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex">
        ...
        <main class="flex-grow p-6">
            ...
            <!-- Header -->
            <header class="mb-6">
                <h2 class="text-3xl font-semibold text-gray-800">Laporan Akhir</h2>
            </header>
                ...
                <table class="table-auto w-full text-left border-collapse">
                    <thead class="bg-blue-800 text-white">
                        <tr>
                            ...
                            <th class="border px-4 py-2 text-sm font-medium">Tanggal Pengerjaan</th>
                            <th class="border px-4 py-2 text-sm font-medium">Status</th>
                            <th class="border px-4 py-2 text-sm font-medium">Umur (hari)</th>
                    ...
                    <tbody>
                        <tr class="odd:bg-gray-50">
                            ...
                            <td class="border px-4 py-2 text-sm">2024-08-10</td>
                            <td class="border px-4 py-2 text-sm">2024-08-20</td>
                            ...
                            <td class="border px-4 py-2 text-sm text-center">10</td>
                            <td class="border px-4 py-2 text-sm">Budi</td>
                        </tr>
